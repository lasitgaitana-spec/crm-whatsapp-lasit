...
export default function SettingsConnectionWhatsApp() {
  ...
  return (
    <Stack spacing={2}>
      <Typography variant="h5">Conexión: WhatsApp</Typography>
      {error && (
      ...
      <Paper sx={{ p: 2 }}>
        <Box sx={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', flexWrap: 'wrap', gap: 2 }}>
          <Box>
            <Typography variant="subtitle1">Estado: {status}</Typography>
            {user && (
